...
document.addEventListener('DOMContentLoaded',function(){const e=window.showCodes||[1,2,3],t={1:{img:window.pageQr||"",caption:"↑扫码打开本页面↑"},2:{img:"/img/wxzym.webp",caption:"↑微信打赏↑"},3:{img:"/img/qqqewm.webp",caption:"↑Gmeek群↑"}},n=[];for(let r of e)t[r]&&n.push({id:r,img:t[r].img,caption:t[r].caption});n.length||n.push({id:0,img:"",caption:"无二维码"});let i=0,o=!1;const a=document.createElement("style");a.textContent=".qr-fresh-root{position:fixed;bottom:58px;right:2px;z-index:9999;font-family:system-ui, -apple-system, 'Segoe UI',Roboto,sans-serif}.qr-fresh-btn{background:linear-gradient(135deg,#f74023 0%,#e63014 100%);border-radius:40px;padding:10px 20px;box-shadow:0 4px 12px rgba(0,0,0,.2);cursor:pointer;color:#fff;font-weight:600;font-size:15px;letter-spacing:1px;transition:all .2s;text-align:center;white-space:nowrap;user-select:none}.qr-fresh-btn:hover{transform:scale(1.02);background:linear-gradient(135deg,#e63a1e 0%,#d42c12 100%)}.qr-fresh-btn:active{transform:scale(.98)}.qr-fresh-panel{position:absolute;bottom:70px;right:0;width:300px;background:#fff;border-radius:24px;box-shadow:0 20px 35px -12px rgba(0,0,0,.25),0 0 0 1px rgba(0,0,0,.02);overflow:hidden;transition:opacity .2s,transform .2s;opacity:0;transform:translateY(12px);visibility:hidden;pointer-events:none}.qr-fresh-panel.open{opacity:1;transform:translateY(0);visibility:visible;pointer-events:auto}.qr-main-area{padding:20px 20px 16px;text-align:center;border-bottom:1px solid #f0f0f0}.qr-main-img{width:180px;height:180px;object-fit:cover;border-radius:16px;background:#f8f8f8;box-shadow:0 4px 12px rgba(0,0,0,.08);display:block;margin:0 auto}.qr-main-caption{font-size:14px;color:#5e5e5e;margin-top:12px;font-weight:500;background:#f9f9f9;display:inline-block;padding:4px 16px;border-radius:30px}.qr-switch-bar{padding:12px 12px 16px;display:flex;flex-wrap:wrap;gap:12px;justify-content:center}.qr-switch-item{flex:0 0 auto;width:70px;cursor:pointer;border-radius:16px;padding:8px 4px 6px;background:#fff;transition:all .2s;text-align:center;border:1px solid #eaeef2}.qr-switch-item:hover{background:#fff7f5;transform:translateY(-2px);border-color:#f74023}.qr-switch-item.active{background:#fef2ef;border-color:#f74023;position:relative}.qr-switch-item.active::after{content:'';position:absolute;top:-1px;left:20%;width:60%;height:3px;background:#f74023;border-radius:3px 3px 0 0}.qr-switch-thumb{width:52px;height:52px;object-fit:cover;border-radius:12px;background:#f5f5f5;margin-bottom:5px;display:block;margin-left:auto;margin-right:auto}.qr-switch-label{font-size:11px;font-weight:500;color:#4a4a4a;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:66px}@media (max-width:480px){.qr-fresh-panel{width:280px;right:-4px}.qr-main-img{width:160px;height:160px}.qr-switch-item{width:64px}.qr-switch-thumb{width:46px;height:46px}}",document.head.appendChild(a);const s=document.createElement("div");s.className="qr-fresh-root";const l=document.createElement("div");l.className="qr-fresh-btn",l.textContent="扫码打开 / 赏 / Q群";const d=document.createElement("div");d.className="qr-fresh-panel";const c=document.createElement("div");c.className="qr-main-area";const m=document.createElement("img");m.className="qr-main-img",m.alt="二维码";const u=document.createElement("div");u.className="qr-main-caption";c.appendChild(m),c.appendChild(u);const p=document.createElement("div");p.className="qr-switch-bar";d.appendChild(c),d.appendChild(p),s.appendChild(l),s.appendChild(d),document.body.appendChild(s);let g=[];function h(){p.innerHTML="",g=[];n.forEach((e,t)=>{const r=document.createElement("div");r.className="qr-switch-item",t===i&&r.classList.add("active");const o=document.createElement("img");o.className="qr-switch-thumb",o.src=e.img,o.alt=`二维码${e.id}`,o.onerror=function(){this.src="https://via.placeholder.com/52x52?text=404"};const a=document.createElement("div");a.className="qr-switch-label",a.textContent=1===e.id?"本页":2===e.id?"赏":"群",r.appendChild(o),r.appendChild(a),r.addEventListener("click",(r=>{r.stopPropagation(),t!==i&&(i=t,b(),f())})),p.appendChild(r),g.push(r)})}function b(){const e=n[i];if(e){if(1===e.id){const t=encodeURIComponent(window.location.href),r=`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${t}`;m.src=r,e.img=r,g[i]&&(g[i].querySelector(".qr-switch-thumb").src=`https://api.qrserver.com/v1/create-qr-code/?size=52x52&data=${t}`)}else m.src=e.img;u.textContent=e.caption,m.onerror=()=>{m.src="https://via.placeholder.com/160x160?text=加载失败",u.textContent=e.caption+" (失效)"}}}function f(){g.forEach(((e,t)=>{t===i?e.classList.add("active"):e.classList.remove("active")}))}h(),b();function v(){o?d.classList.remove("open"):d.classList.add("open"),o=!o}l.addEventListener("click",(e=>{e.stopPropagation(),v()})),document.addEventListener("click",(e=>{o&&!s.contains(e.target)&&(d.classList.remove("open"),o=!1)})),document.addEventListener("keydown",(e=>{"Escape"===e.key&&o&&(d.classList.remove("open"),o=!1)}));const y=n.find(e=>1===e.id);if(y){const e=()=>{if(y&&o&&i===n.indexOf(y)){const e=encodeURIComponent(window.location.href),t=`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${e}`;m.src=t,y.img=t,g[i]&&(g[i].querySelector(".qr-switch-thumb").src=`https://api.qrserver.com/v1/create-qr-code/?size=52x52&data=${e}`)}else if(y){const e=encodeURIComponent(window.location.href);y.img=`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${e}`,n.forEach(((t,r)=>{1===t.id&&g[r]&&(g[r].querySelector(".qr-switch-thumb").src=`https://api.qrserver.com/v1/create-qr-code/?size=52x52&data=${e}`)}))}};const t=history.pushState;history.pushState=function(...n){t.apply(this,n),e()};const r=history.replaceState;history.replaceState=function(...t){r.apply(this,t),e()},window.addEventListener("popstate",e)}window.updateQRSequence=function(t){if(!Array.isArray(t))return!1;const r=[];for(let i of t)if(qrData[i]){let o=qrData[i].img;1===i&&(o=`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${encodeURIComponent(window.location.href)}`),r.push({id:i,img:o,caption:qrData[i].caption})}if(0===r.length)return!1;n.length=0,n.push(...r),i=0,h(),b(),f();return!0}});
