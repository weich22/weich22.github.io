...
建议先用 版本二试试,因为它能保证日期的统一完整性,看起来更专业。
...
/* 2. 核心：强制日期始终排在第一行最右侧 */
.LabelTime {
    order: -1 !important;        /* 让日期在逻辑上排到最前面 */
    margin-left: auto !important; /* 把它推向右侧边缘 */
    order: 1 !important;         /* 恢复视觉顺序，但 margin-left:auto 会撑开空间 */
    white-space: nowrap !important;
    flex-shrink: 0 !important;   /* 绝对不许压缩日期宽度 */
    padding-left: 10px !important;
}

/* 3. 标签：允许被挤压换行 */
.Label, .LabelName {
    flex-shrink: 1 !important;   /* 空间不足时，优先让标签换行 */
}
